...
<p className="right-align"><b>Irwin</b>: I’d been mining for 30 years, off and on. Underground Uranium mostly. Jon was starting this. I decided I wanted to stay home more. I’d been suit-casing in a hotel for two, three, four months sometimes. It wasn’t miserable, but I was ready to be home more. 
</p>
...
<p className="right-align"><b>Irwin</b>: Ya, that’s the first thing that came to my mind is “different.” I’ve been around long enough to know people how they are and sales and all that stuff. That was one of the first things we talked about was we aren’t going to do things the way other companies do things. 
</p>
...
<p className="right-align"><b>Irwin</b>: I find us selling us, more than selling vehicles. We’re building trust. People show up, and we end up just talking with people and people realize, “hey, these guys are different.” 
</p>
...
<p className="right-align"><b>Irwin</b>: Well, I’ll back up a line. Some BS. (laughing)
</p>
<p className="question"><b>Ian</b>: (laughing) Okay, what kind of BS can people expect from Strickland Auto?
</p>
<p className="right-align"><b>Irwin</b>: Well, there’s lots of BS- I mean, we BS with customers all the time. 
</p>
<p className="question"><b>Ian</b>: Oh, like, conversational BS?
</p>
<p className="right-align"><b>Irwin</b>: YA! We find ourselves saying things that normal salesmen don’t say. We’ll point things out that other people would not. With that, we say, THIS is what you’re getting. We’re transparent. What you see is what you get. That’s what people should expect.
 </p>
 </div>
